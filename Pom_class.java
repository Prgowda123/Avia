...
public class Pom_class extends utilies  {
	 WebDriver driver;
	    ...
	    public void switc() throws InterruptedException
	    {
	    ...
	    public void excel() throws ParseException, AWTException, InterruptedException {
	    	  FileInputStream fis = null;
	    	    ...
	    	    try {
	    			...
	    			for (int i = 2; i <= 100; i++) { // Start from row 1 to skip header
